...
android {
    namespace = "org.luben93"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "org.luben93"
    ...
    signingConfigs {
        ...
        create("release") {
            // Use debug keystore for release builds to ensure APK is installable
            // In production, this should use a proper release keystore
